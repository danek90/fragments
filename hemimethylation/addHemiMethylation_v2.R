...
filtered_DMRs <- data.frame(read_excel("ERPlus_HER2Minus_DSS_75percent.xlsx"))
...
bismarkBSeq <- read.bismark(files = "ERPlus_HER2Minus_S1_L001_R1_001_00_bismark_bt2_pe.cat.rmdup.bismark.cov.gz", 
...
write.xlsx(final_output, "hemiMethylation_ERplusHER2minus_DSS.xlsx")
...
filtered_tag <- data.frame(read_excel("ERPlus_HER2Minus_DSS_75percent.xlsx"))
